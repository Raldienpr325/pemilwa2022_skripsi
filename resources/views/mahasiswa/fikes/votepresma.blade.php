...
@section('content')
    <center>
        <h1 style="padding-top:30px;font-family:Monaco,Helvetica, sans-serif"><strong> Presiden Mahasiswa
            </strong>
        </h1>
        ...
        <div class="container" style="padding: 20px">
            <div class="row">
                @foreach ($dataFikes as $item)
                    ...
                    <form action="{{ route('storeVoting3', $item->id) }}" id="voting" method="post">
                        @method('POST')
                        @csrf
