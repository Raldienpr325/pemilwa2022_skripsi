...
@section('content')
    <center>
        <h1 style=padding-top:30px;font-family:Arial, Helvetica, sans-serif"><strong> Presiden Mahasiswa</strong>
        </h1>
        ...
        <div class="container" style="padding: 20px">
            <div class="row">
                @foreach ($data as $item)
                    <center>
                        <div class="col-md-4 p-md-4" style="">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <button type="button" class="glow-on-hover" data-bs-toggle="modal"
                                        data-bs-target="#presmafk{{ $item->id }}">Vote</button>
                                </div>
                            </div>
                        </div>
                    </center>
                    <form action="{{ route('storeVoting', $item->id) }}" id="voting" method="post">
                        @method('POST')
                        @csrf
                        <div class="modal fade" id="presmafk{{ $item->id }}" data-bs-backdrop="static"
