...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Presiden Mahasiswa Fakultas Ilmu Kesehatan</h6>
            <a href="{{ route('presma-fikes.create') }}" class="btn btn-success btn-sm shadow-sm">Add Data</a>
        </div>
        <div class="card-body">
                    ...
                    <tbody class="body-td">
                        ...
                        <td>
                            <div class="row" style="margin-left: 0">
                                <form action="{{ route('presma-fikes.destroy', $item->id) }}" method="POST"
                                    style="width:50%">
                                    @csrf
                                    @method('delete')
                                ...
                                <button class=" btn btn-success" style="color:white;font-weight:600;font-size:12px">
                                    ...
                                    <a href="{{ route('presma-fikes.edit', $item->id) }}"
