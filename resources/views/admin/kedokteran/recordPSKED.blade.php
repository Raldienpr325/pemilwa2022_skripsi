...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Mahasiswa PSKED</h6>
            <div class="col-6">
                <a href="{{ route('exportpsked') }}"><button class="btn sm btn-success float-right mt-2 mr-2">Export</button></a>
            </div>
        </div>
        <div class="card-body">
