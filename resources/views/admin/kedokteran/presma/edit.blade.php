...
@section('content')
    <div class="card-header">
        Edit Presma Fakultas Kedokteran
    </div>
    <div class="content">
        <div class="card-body">
